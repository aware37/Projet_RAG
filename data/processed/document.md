...
|                                                                                                     | The red vehicle is on the<br/>right side of the image. |                              |                   | **RE-Search** |
...
| ![](image1)                                                                                                                                                                                                                              | ![](image2) | ![](image3)                                          | **Semantic Similarity**<br/>![](heatmap)             |                                            | ![](image4) | ![](sad_face) |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ---------------------------------------------------- | ---------------------------------------------------- | ------------------------------------------ | ----------- | ------------- |
| **What is the color of the baby carriage?**<br/>A. The color of the baby carriage is black.<br/>B. The color of the baby carriage is green.<br/>C. The color of the baby carriage is red.<br/>D. The color of the baby carriage is blue. | ![](crop1)  | ![](crop2)<br/>**Answer: B**<br/>**Resolution=96**   | ![](crop3)<br/>**Answer: B**<br/>**Resolution=112**  | ![](heatmap_large)<br/>**Resolution =112** |             |               |
|                                                                                                                                                                                                                                          |             | ![](crop4)<br/>**Answer: B**<br/>**Resolution =144** | ![](crop5)<br/>**Answer: A**<br/>**Resolution =224** |                                            |             |               |
| **0** **1**                                                                                                                                                                                                                              |             |                                                      |                                                      |                                            |             |               |
...
\tilde{p}_{i,1} & \tilde{p}_{i,2} & \cdots & \tilde{p}_{i,k} \\
\tilde{p}_{i,(k+1)} & \tilde{p}_{i,(k+2)} & \cdots & \tilde{p}_{i,(2k)} \\
\vdots & \vdots & \ddots & \vdots \\
\tilde{p}_{i,(k(k-1)+1)} & \tilde{p}_{i,(k(k-1)+2)} & \cdots & \tilde{p}_{i,k^2}
\end{bmatrix}$$ (2)
...
$$s^F(i, j) = (1 - w) \cdot s^f(i, j) + w \cdot \mathbf{c}^g(i, j) \tag{11}$$
...
| ![Graph showing accuracy vs resolution for Single task. LLaVA-v1.5-7B-MRD (green circles, solid line) shows highest performance around 95%, LLaVA-ov-0.5B-MRD (blue triangles, solid line) shows performance around 85-90%, LLaVA-v1.5-7B-RAP (green circles, dashed line) shows performance around 88-90%, and LLaVA-ov-0.5B-RAP (blue triangles, dashed line) shows performance around 75-85%. X-axis shows resolution values: 96, 112, 144, 160, 224. Y-axis shows Accuracy(%) from 75 to 95.]() (a) Single | ![Graph showing accuracy vs resolution for Cross task. LLaVA-v1.5-7B-MRD (green circles, solid line) shows highest performance around 90-95%, LLaVA-ov-0.5B-MRD (blue triangles, solid line) shows performance around 85%, LLaVA-v1.5-7B-RAP (green circles, dashed line) shows performance around 92-95%, and LLaVA-ov-0.5B-RAP (blue triangles, dashed line) shows performance around 75-85%. X-axis shows resolution values: 96, 112, 144, 160, 224. Y-axis shows Accuracy(%) from 75 to 95.]() (b) Cross | ![Graph showing accuracy vs resolution for Overall task. LLaVA-v1.5-7B-MRD (green circles, solid line) shows highest performance around 95%, LLaVA-ov-0.5B-MRD (blue triangles, solid line) shows performance around 85-87%, LLaVA-v1.5-7B-RAP (green circles, dashed line) shows performance around 90-92%, and LLaVA-ov-0.5B-RAP (blue triangles, dashed line) shows performance around 75-85%. X-axis shows resolution values: 96, 112, 144, 160, 224. Y-axis shows Accuracy(%) from 75 to 95.]() (c) Overall |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| ![Graph showing accuracy vs Max Step for Single task. LLaVA-v1.5-7B-MRD (green circles, solid line) shows highest performance around 90%, LLaVA-ov-0.5B-MRD (blue triangles, solid line) shows performance around 90%, LLaVA-v1.5-7B-RAP (green circles, dashed line) shows performance around 80%, and LLaVA-ov-0.5B-RAP (blue triangles, dashed line) shows performance around 40-80%. X-axis shows Max Step values: 1, 10, 30, 50, 100, 200. Y-axis shows Accuracy(%) from 40 to 90.]() (a) Single | ![Graph showing accuracy vs Max Step for Cross task. LLaVA-v1.5-7B-MRD (green circles, solid line) shows highest performance around 95%, LLaVA-ov-0.5B-MRD (blue triangles, solid line) shows performance around 82-85%, LLaVA-v1.5-7B-RAP (green circles, dashed line) shows performance around 82-85%, and LLaVA-ov-0.5B-RAP (blue triangles, dashed line) shows performance around 65-82%. X-axis shows Max Step values: 1, 10, 30, 50, 100, 200. Y-axis shows Accuracy(%) from 65 to 95.]() (b) Cross | ![Graph showing accuracy vs Max Step for Overall task. LLaVA-v1.5-7B-MRD (green circles, solid line) shows highest performance around 90%, LLaVA-ov-0.5B-MRD (blue triangles, solid line) shows performance around 90%, LLaVA-v1.5-7B-RAP (green circles, dashed line) shows performance around 85-90%, and LLaVA-ov-0.5B-RAP (blue triangles, dashed line) shows performance around 50-85%. X-axis shows Max Step values: 1, 10, 30, 50, 100, 200. Y-axis shows Accuracy(%) from 50 to 90.]() (c) Overall |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| ![Legend showing: LLaVA-ov-0.5B-MRD (blue triangle), LLaVA-v1.5-7B-MRD (green circle), LLaVA-ov-0.5B-RAP (blue dashed line), LLaVA-v1.5-7B-RAP (green dashed line)](legend) |                                                                                                                         |                                                                                                                             |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| ![Chart (a) Single showing accuracy vs weight from 0 to 1.0, with values ranging from 80.0% to 95.0%](chart_a)<br/>(a) Single                                               | ![Chart (b) Cross showing accuracy vs weight from 0 to 1.0, with values ranging from 80% to 96%](chart_b)<br/>(b) Cross | ![Chart (c) Overall showing accuracy vs weight from 0 to 1.0, with values ranging from 84% to 96%](chart_c)<br/>(c) Overall |
...
| ![Legend showing: LLaVA-ov-0.5B-MRD (blue triangle), LLaVA-v1.5-7B-MRD (green circle), LLaVA-ov-0.5B-RAP (blue dashed line), LLaVA-v1.5-7B-RAP (green dashed line)](legend) |                                                                                                                                 |                                                                                                                                     |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| ![Chart (a) Single showing accuracy vs window size from 896 to 1568, with values ranging from 80.0% to 95.0%](chart_a)<br/>(a) Single                                       | ![Chart (b) Cross showing accuracy vs window size from 896 to 1568, with values ranging from 82% to 96%](chart_b)<br/>(b) Cross | ![Chart (c) Overall showing accuracy vs window size from 896 to 1568, with values ranging from 84% to 96%](chart_c)<br/>(c) Overall |


Figure 9. The effect of the detection window size in *MRD*.

Table 3. Comparison of *MRD* with existing works on high-resolution benchmarks. We conduct experiments on V* Bench and HR-Bench using LLaVA-v1.5 7B.

| Method         | V\* Bench<br/>Attribute | V\* Bench<br/>Spatial | V\* Bench<br/>Overall | HR-Bench 4K<br/>FSP | HR-Bench 4K<br/>FCP | HR-Bench 4K<br/>Overall | HR-Bench 8K<br/>FSP | HR-Bench 8K<br/>FCP | HR-Bench 8K<br/>Overall | Δ(↑)  |
| -------------- | ----------------------- | --------------------- | --------------------- | ------------------- | ------------------- | ----------------------- | ------------------- | ------------------- | ----------------------- | ----- |
| LLaVA-v1.5-7B  | 43.5                    | 56.6                  | 48.7                  | 38.5                | 33.8                | 36.1                    | 33.0                | 31.3                | 32.1                    | -     |
| -w/ DC²        | 49.6                    | 59.2                  | 51.6                  | 45.3                | 37.0                | 41.1                    | 36.5                | 33.3                | 34.9                    | +3.5  |
...
|             | ![](building_facade.jpg)                                                     | ![](rap_sim_map2.jpg) | ![](det_conf_map2.jpg) | ![](mrd_fusion_map2.jpg) | ![](rap_result2.jpg) | ![](mrd_result2.jpg) |
...
|             | ![](cathedral.jpg)                                                           | ![](rap_sim_map4.jpg) | ![](det_conf_map4.jpg) | ![](mrd_fusion_map4.jpg) | ![](rap_result4.jpg) | ![](mrd_result4.jpg) |
...
|             | ![](cityscape.jpg)                                                           | ![](rap_sim_map6.jpg) | ![](det_conf_map6.jpg) | ![](mrd_fusion_map6.jpg) | ![](rap_result6.jpg) | ![](mrd_result6.jpg) |
...
|             | HR Image                                                                                      | RAP Sim Map               | Det Conf Map               | MRD Fusion Map               | RAP Result                                                  | MRD Result                                                     |
| ----------- | --------------------------------------------------------------------------------------------- | ------------------------- | -------------------------- | ---------------------------- | ----------------------------------------------------------- | -------------------------------------------------------------- |
| V\* Bench   | ![](beach_scene)                                                                              | ![](rap_sim_map_beach)    | ![](det_conf_map_beach)    | ![](mrd_fusion_map_beach)    | ![](rap_result_beach)<br/>right side ✗                      | ![](mrd_result_beach)<br/>left side ✓                          |
|             | Query: Is the **yellow umbrella** on the left or right side of the **pink umbrella**?         |                           |                            |                              |                                                             |                                                                |
|             | ![](tower_scene)                                                                              | ![](rap_sim_map_tower)    | ![](det_conf_map_tower)    | ![](mrd_fusion_map_tower)    | ![](rap_result_tower)<br/>right side ✗                      | ![](mrd_result_tower)<br/>left side ✓                          |
|             | Query: Is the **dog** on the left or right side of the **golden tower**?                      |                           |                            |                              |                                                             |                                                                |
| HR-Bench-kK | ![](hallway_scene)                                                                            | ![](rap_sim_map_hallway)  | ![](det_conf_map_hallway)  | ![](mrd_fusion_map_hallway)  | ![](rap_result_hallway)<br/>One ✗                           | ![](mrd_result_hallway)<br/>Two ✓                              |
|             | Query: How many **chairs** are there in the image?                                            |                           |                            |                              |                                                             |                                                                |
|             | ![](sailboat_scene)                                                                           | ![](rap_sim_map_sailboat) | ![](det_conf_map_sailboat) | ![](mrd_fusion_map_sailboat) | ![](rap_result_sailboat)<br/>Two ✗                          | ![](mrd_result_sailboat)<br/>Four ✓                            |
|             | Query: How many **people** are there in the boat?                                             |                           |                            |                              |                                                             |                                                                |
| HR-Bench-8K | ![](royal_albert_hall)                                                                        | ![](rap_sim_map_hall)     | ![](det_conf_map_hall)     | ![](mrd_fusion_map_hall)     | ![](rap_result_hall)<br/>Behind the bus ✗                   | ![](mrd_result_hall)<br/>To the left of the bus ✓              |
|             | Query: What is the position of the **Royal Albert Hall** relative to the **bus**?             |                           |                            |                              |                                                             |                                                                |
|             | ![](building_scene)                                                                           | ![](rap_sim_map_building) | ![](det_conf_map_building) | ![](mrd_fusion_map_building) | ![](rap_result_building)<br/>In front of<br/>the building ✗ | ![](mrd_result_building)<br/>To the left of<br/>the building ✓ |
